...
exports.GetAllActionLotesUseCase = void 0;
var prismaClient_1 = require("../../../../database/prismaClient");
var GetAllActionLotesUseCase = /** @class */ (function () {
    function GetAllActionLotesUseCase() {
    }
    GetAllActionLotesUseCase.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prismaClient_1.prisma.actionLotes.count({
                                where: {
                                    id: {
                    ...
                    case 1:
                        total = _b.sent();
                        return [4 /*yield*/, prismaClient_1.prisma.actionLotes.findMany({
                                where: {
                                    id_lote: { equals: id }
                                    // id_lote: {
    ...
    return GetAllActionLotesUseCase;
}());
exports.GetAllActionLotesUseCase = GetAllActionLotesUseCase;
//# sourceMappingURL=GetAllActionLotesUseCase.js.map