...
var CreateLocationController = /** @class */ (function () {
    ...
    CreateLocationController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, id_section, id_user_create, createLocationUseCase, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, description = _a.description, id_section = _a.id_section;
