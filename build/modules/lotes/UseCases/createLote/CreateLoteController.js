...
var CreateLoteController = /** @class */ (function () {
    ...
    CreateLoteController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, propDate, id_propagationType, id_genetic, id_location_init, qtTotal, obs, id_user_create, createLoteUseCase, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, propDate = _a.propDate, id_propagationType = _a.id_propagationType, id_genetic = _a.id_genetic, id_location_init = _a.id_location_init, qtTotal = _a.qtTotal, obs = _a.obs;
